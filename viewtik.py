...
class Zefoy:
	...
	def __init__(self):
		...
		self.url = 'None'
		self.text = 'Gbao.Exe'
		url1=input(" \033[1;97m[\033[1;31mGbao\033[1;97m] =>  Nhập link video: ")
		self.url=url1
	...
	def get_captcha(self):
		...
		try:
			...
			print(' \033[1;97m[\033[1;31mGbao\033[1;97m] =>  Đang giải capcha..')
			return False
		except Exception as e:
			print(f" \033[1;97m[\033[1;31mGbao\033[1;97m] =>  Không thể giải captcha: {e}")
			time.sleep(2)
			self.get_captcha()

	def send_captcha(self, new_session = False):
		if new_session: self.session = requests.Session(); os.remove('session'); time.sleep(2)
		if self.get_captcha(): print(' \033[1;97m[\033[1;31mGbao\033[1;97m] =>  Đang kêt nối đến session');return (True, 'The session already exists')
		...
		if 'Enter Video URL' in request.text: 
			print(' \033[1;97m[\033[1;31maGbao\033[1;97m] =>  Session đã được tạo')
			open('session','w',encoding='utf-8').write(self.session.cookies.get('PHPSESSID'))
			print(f" \033[1;97m[\033[1;31mGbao\033[1;97m] =>  Giải capcha thành công: {captcha_solve}")
	...
	def find_video(self):
		...
		while True:
			...
			if 'Session expired. Please re-login' in self.video_info: print(' \033[1;97m[\033[1;31mGbao\033[1;97m] =>  Phiên hết hạn. Đang đăng nhập lại...');self.send_captcha(); return
			elif 'service is currently not working' in self.video_info: return (True,' \033[1;97m[\033[1;31mGbao\033[1;97m] =>  Dịch vụ hiện không hoạt động, hãy thử lại sau. | Bạn có thể thay đổi nó trong cấu hình.')
				...
				elif lamtilo >= 1000: print(' \033[1;97m[\033[1;31mGbao\033[1;97m] =>  Your IP was banned')
				_=time.time()
				while time.time()-2<_+lamtilo:
					t-=1
					print("\r\033[1;31m[\033[1;33mBao\033[1;31m] \033[1;98m ~>       \033[1;92m G      \033[1;91m | {0} ".format(t)+" | \r ", end='')
					sleep(0.14)
					print("\r\033[1;31m[\033[1;33mBao\033[1;31m] \033[1;97m   ~>     \033[1;93m GI     \033[0;31m | {0} ".format(t)+" | \r ", end='')
					sleep(0.14)
					print("\r\033[1;31m[\033[1;33mGbao\033[1;31m] \033[1;96m     ~>   \033[1;94m GIA    \033[0;31m | {0} ".format(t)+" | \r", end='')
					sleep(0.14)
					print("\r\033[1;31m[\033[1;33mGbao\033[1;31m] \033[1;95m       ~> \033[1;95m GIABAO   \033[0;31m | {0} ".format(t)+" | \r", end='')
					sleep(0.14)
					print("\r\033[1;31m[\033[1;33mGbao\033[1;31m] \033[1;94m        ~>\033[1;96m GIABAO.  \033[0;31m | {0} ".format(t)+" | \r", end='')
					sleep(0.14)
					print("\r\033[1;31m[\033[1;33mGbao\033[1;31m] \033[1;93m        ~>\033[1;97m GIABAO.E \033[0;31m | {0} ".format(t)+" | \r", end='')
					sleep(0.14)
					print("\r\033[1;31m[\033[1;33mGbao\033[1;31m] \033[1;92m        ~>\033[1;98m GIABAO.EX\033[0;31m | {0} ".format(t)+" | \r", end='')
					sleep(0.14)
					print("\r\033[1;31m[\033[1;33mGbao\033[1;31m] \033[1;91m        ~>\033[1;95m GIABAO.EXE\033[0;31m | {0} ".format(t)+" | \r", end='')
					sleep(0.14)
				print("\r\r\033[1;95m    Trần Gia Bảo \033[1;97m                         \r", end='')
				time.sleep(1)
	...
	def use_service(self):
		...
		if 'Session expired. Please re-login' in res: print(' \033[1;97m[\033[1;31mGbao\033[1;97m] =>  Phiên hết hạn. Đang đăng nhập lại...');self.send_captcha(); return ""
		elif 'Too many requests. Please slow' in res: time.sleep(3)
		elif 'service is currently not working' in res: return (' \033[1;97m[\033[1;31mGbao\033[1;97m] =>  Dịch vụ hiện không hoạt động, hãy thử lại sau. | Bạn có thể thay đổi nó trong cấu hình.')
		else: print(" \033[1;97m[\033[1;31mGbao\033[1;97m] => ",res.split("sans-serif;text-align:center;color:green;'>")[1].split("</")[0])
	...
	def get_video_id(self, url_ = None, set_url=True):
		...
		if request.text == '': print(' \033[1;97m[\033[1;31mGbao\033[1;97m] =>  Link video không hợ lệ'); return False
	...
	def update_name(self):
		while True:
			try:
				...
				self.text = f" [Gbao] | Views: {video_info['viewCount']} "
			except: pass
			time.sleep(5)
...
a = " \033[1;97m[\033[1;31mGbao\033[1;97m] => "
trang = "\033[1;37m"
xanh_la = "\033[1;32m"
...
\033[1;32m ──────────▀
\033[1;34m╠═════════════════════════════════════════════════════════════════╣
\033[1;32m║➢ ADMIN :GIA BẢO                                                 ║
\033[1;36m║➢ FB: ᰔ乄ᛜgbaoⴰexeᝰ.ᐟ                                            ║
\033[1;31m║➣ Github:giabao1712                                              ║
\033[1;33m║➣ Zalo : 0325478680                                              ║
\033[1;34m╚═════════════════════════════════════════════════════════════════╝
  """
    print(logo)
ngay = int(strftime('%d'))
...
if 1:
    print(f"{xanh_la} \033[1;97m[\033[1;31mGbao\033[1;97m] =>  Key đúng mời bạn vô tool")
    logo()
    Z = Zefoy()
    ...
    print(f"{do} \033[1;97m[\033[1;31mGbao\033[1;97m] =>  Key sai vui lòng vượt lại")
    exit()

while True:
	try: 
		if 'Service is currently not working, try again later' in str(Z.use_service()): print(f'{do} \033[1;97m[\033[1;31mGbao\033[1;97m] => Dịch vụ hiện không hoạt động, hãy thử lại sau. | Bạn có thể thay đổi nó trong cấu hình.');time.sleep(5)
